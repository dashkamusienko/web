class ExchangeTracker
{
  ...
  getFilters(isStatic)
  {
    return isStatic ? this.getQuery(this.static.concat(this.dynamic), "filter") : this.getQuery(this.dynamic, "filter");
  }
  ...
  updateTimeWorker()
  {
    ...
    document.getElementById('timer').textContent = timeDiff.toFixed(1);
  }
